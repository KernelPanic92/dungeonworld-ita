...
export function Cover() {
  return (
    <section className="w-full bg-neutral-950">
      <div className="flex flex-col justify-center lg:justify-end relative w-full mx-auto max-w-[90rem] pl-[max(env(safe-area-inset-left),1.5rem)] pr-[max(env(safe-area-inset-right),1.5rem)] md:pl-40 md:pr-40 space-y-10 py-10">
        <div className="flex flex-row justify-center lg:justify-end relative w-full">
          ...
          <Image priority src={sciamano} alt="" height={600} width={421} />
        </div>
        <h3 className="text-center mx-auto text-lg font-bold text-neutral-100">
